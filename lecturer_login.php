...
<body style="margin: 0; padding: 0; background: url(images/quizz.jpg); background-size: cover; background-position: center; font-family: sans-serif;">
	<div class="the-form">
		<div class="login-box">
			<img src="images/lecturer.jpg" class="login-image">
			<h1>Login</h1>
			<form action="includes/lecturer_login_process.php" method="POST">
				...
				<h5>Don't have an account? <strong><a href="lecturer_signup.php">Sign Up</a></strong></h5>
			</form>
		</div>
	</div>
</body>
