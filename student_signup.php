...
<body style="margin: 0; padding: 0; background: url(images/quizz.jpg); background-size: cover; background-position: center; font-family: sans-serif;">
	<div class="the-form">
		<div class="signup-box">
			<img src="images/student.jpg" class="signup-image">
			<h1>Sign Up</h1>
			<form action="includes/student_signup_process.php" method="POST">
				<div id="input-box">
				...
				<div id="input-box">
					<label for="id_no"><p>Index No.</p></label>
					<input type="text" name="id_no" id="id_no" placeholder="Please enter your index number">
				</div>
				<div id="input-box">				
